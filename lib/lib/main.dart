...
import 'guided_journey_screen/compare_plans.dart';
import 'guided_journey_screen/compare_plans_screen_file/comapare_plans_appbar.dart';
import 'guided_journey_screen/fin_goal_screen.dart';
import 'guided_journey_screen/plan_details_expansion_tile_screen.dart';
import 'guided_journey_screen/user_details_screen.dart';
import 'income_plan_mg.dart';
import 'manual_journey_screen/bottom_sheet_t&c_screen.dart';
import 'manual_journey_screen/compare_plans_screen_one.dart';
import 'manual_journey_screen/info_content_screen.dart';
import 'manual_journey_screen/user_details.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const IncomePlanMJ(),
      // const ComparePlanAppScreen(),
      // const Screen1(),
    );
  }
}
